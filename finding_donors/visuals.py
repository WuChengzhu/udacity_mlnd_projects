...
def evaluate(results, accuracy, f1):
    ...
    colors = ['#cec61c', '#0cb418', '#A00000', '#00A0A0', '#000000', '#ba1cce', '#f7fdfd']
    ...
    pl.legend(handles = patches, bbox_to_anchor = (1.8, 3), \
               loc = 'upper right', borderaxespad = 0., ncol = 1, fontsize = 'small')
